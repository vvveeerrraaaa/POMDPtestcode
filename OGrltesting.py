...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            ...
            # plt.show()
            np.savez('1gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.
            # , model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('10gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.rewards, model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('50gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.rewards, model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('100gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.rewards, model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('200gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.rewards, model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('500gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
...
for x in range(5):
    ...
    for frame_idx in range(1, config.MAX_FRAMES + 1):
        ...
        if frame_idx % 150000 == 0:
            # plot(frame_idx, model.rewards, model.losses,timedelta(seconds=int(timer()-start)))
            # plt.show()
            np.savez('800gru'+str(x)+'.npz',list(range(len(model.rewards))), model.rewards,model.losses,np.mean(model.rewards[-10:]))
            break
    model.save_w()
    env.close()
